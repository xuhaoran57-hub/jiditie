...
writeWav('tideline-loop.wav', render(1.5, (time, duration) => {
  const fade = envelope(time, duration, 0.04, 0.04);
  return fade * (0.12 * sine(110, time) + 0.045 * sine(220, time) + 0.025 * triangle(1, time));
}));
